...
/*   Updated: 2016/12/21 11:14:31 by hkalia           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		mouse_press(int button, int x, int y, void *param)
{
	...
	if (x >= mlx->win.max.x || y >= mlx->win.max.y || x < 0 || y < 0)
		return (0);
//	ft_printf("\e[34mMouse Press: Button:%d X:%d Y:%d\e[0m\n", button, x, y);
	mlx->mouse.flg = 1;
...
int		mouse_release(int button, int x, int y, void *param)
{
	...
	if (x >= mlx->win.max.x || y >= mlx->win.max.y || x < 0 || y < 0)
		return (0);
//	ft_printf("\e[34mMouse Release: Button:%d X:%d Y:%d\e[0m\n", button, x, y);
	mlx->mouse.flg = 0;
...
int		mouse_motion(int x, int y, void *param)
{
	...
	if (x >= mlx->win.max.x || y >= mlx->win.max.y || x < 0 || y < 0)
		return (0);
//	ft_printf("\e[34mMouse Motion: X:%d Y:%d\e[0m\n", x, y);
	mlx->mouse.pos.x = x;
	mlx->mouse.pos.y = y;
	if (mlx->mouse.flg)
	{
